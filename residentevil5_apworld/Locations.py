...
#         'unique_id': "105_701_0"},
    ...
    {'name': "2-2 Large Gold Pile 2",
         ...
         'arc_file': "s119.arc",
         'unique_id': "119_371_0"},
# There is apparently a 2nd Jewel Beetle somewhere in this stage? Only one here should be on the tree, check duplicates in game files later on I guess.         
#    {'name': "2-2 Jewel Beetle on Tree",
#         'chapter': Chapters.c22_station,
#         'arc_file': "s119.arc",
#         'unique_id': "119_261_0"},
#
# Okay I know we CAN randomize this, but please god do NOT randomize this outside of the mines. It will be unplayable and it can only persist in a per-stage basis. So like, where else would you put it?
#
#    {'name': "2-2 Lantern",
#         'chapter': Chapters.c22_mines,
#         'arc_file': "s119.arc",
#         'unique_id': "119_41_0"},
    {'name': "2-2 Red Herb in Cave First Branch",
         'chapter': Chapters.c22_mines,
         'arc_file': "s119.arc",
         'unique_id': "119_96_0"},
    {'name': "2-2 HG Ammo in Cave First Branch",
         'chapter': Chapters.c22_mines,
         'arc_file': "s119.arc",
         'unique_id': "119_151_0"},
    {'name': "2-2 Flash Grenade in Cave Second Branch",
         'chapter': Chapters.c22_mines,
         'arc_file': "s119.arc",
         'unique_id': "119_206_0"},
    {'name': "2-2 Green Herb in Cave Second Branch",
         'chapter': Chapters.c22_mines,
         'arc_file': "s119.arc",
         'unique_id': "119_261_0"},
    {'name': "2-2 Green Herb on Cave Ground",
         'chapter': Chapters.c22_mines,
         'arc_file': "s119.arc",
         'unique_id': "119_316_0"},
    {'name': "2-2 Diamond in Chest",
         'chapter': Chapters.c22_mines,
         'arc_file': "s119.arc",
         'unique_id': "119_371_0"},
    ...
    {'name': "2-2 Ruby Pear in Quarry 2",
         ...
         'arc_file': "s119.arc",
         'unique_id': "119_481_0"},
    {'name': "2-2 Ruby Square in Quarry 1",
         'chapter': Chapters.c22_mines,
         'arc_file': "s119.arc",
         'unique_id': "119_591_0"},
    {'name': "2-2 Ruby Square in Quarry 2",
         'chapter': Chapters.c22_mines,
         'arc_file': "s119.arc",
         'unique_id': "119_646_0"},
    {'name': "2-2 Flash Grenade Near Elevator 1",
         'chapter': Chapters.c22_mines,
         'arc_file': "s119.arc",
         'unique_id': "119_701_0"},
    {'name': "2-2 Flash Grenade Near Elevator 2",
         'chapter': Chapters.c22_mines,
         'arc_file': "s119.arc",
         'unique_id': "119_756_0"},
