...
class RE5World(World):
    ...
    def __init__(self, multiworld: MultiWorld, player: int):
        ...
        self.item_classification: Dict[BRCType, ItemClassification] = {
            ...
            RE5Type.Assault: ItemClassification.progression_skip_balancing,
            RE5Type.Magnum: ItemClassification.progression_skip_balancing,
            RE5Type.Explosive: ItemClassification.progression_skip_balancing,
            RE5Type.Special: ItemClassification.progression_skip_balancing,
            RE5Type.Treasure: ItemClassification.useful,
            RE5Type.Handgun: ItemClassification.progression_skip_balancing,
            RE5Type.SMG: ItemClassification.progression_skip_balancing,
            RE5Type.Shotgun: ItemClassification.progression_skip_balancing,
